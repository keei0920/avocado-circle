...
ActiveRecord::Schema[7.0].define(version: 2023_11_28_140842) do
  create_table "avocados", charset: "utf8", force: :cascade do |t|
  ...
  create_table "users", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "avocado_id"
    t.index ["avocado_id"], name: "index_users_on_avocado_id"
